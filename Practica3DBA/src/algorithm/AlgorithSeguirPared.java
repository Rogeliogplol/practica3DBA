...
public class AlgorithSeguirPared {
    ...
    /**
    * Devuelve la dirección más prometedora
    * 
    * @param casillas La matriz de 3x3 alrededor del dron y entre las que elegir
    * la casilla más prometedora
    * 
    * @return Devuelve el String que contiene la dirección o un error
    * 
    * @author Juan Manuel Navarrete Carrascosa
    * @author Rogelio
    */
    ...
    /**
    * Devuelve la dirección a tomar para seguir la pared hacia la derecha
    * 
    * @param casillas La matriz de 3x3 alrededor del dron y entre las que elegir
    * la casilla a moverse
    * 
    * @return Devuelve el String que contiene la dirección o un error
    * 
    * @author Juan Manuel Navarrete Carrascosa
    ...
    */
    ...
    public String moverParedDer(Casilla[][] casillas){
    ...
    /**
    * Devuelve la dirección a tomar para seguir la pared hacia la izquierda
    * 
    * @param casillas La matriz de 3x3 alrededor del dron y entre las que elegir
    * la casilla a moverse
    * 
    ...
    */
    ...
    /**
    * Devuelve la dirección a tomar procesando los datos del sensor
    * 
    * @param sensor La matriz de 3x3 alrededor del dron y entre las que elegir
    * la casilla a moverse
    * 
    * @return Devuelve el String que contiene la dirección o un error
    * 
